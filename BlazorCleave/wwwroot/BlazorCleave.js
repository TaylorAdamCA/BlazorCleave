...
/******/ 	return __webpack_require__(__webpack_require__.s = "./BlazorCleave.ts");
/******/ })
/************************************************************************/
/******/ ({
...
Object.defineProperty(exports, "__esModule", { value: true });
var cleave_js_1 = __importDefault(__webpack_require__(/*! cleave.js */ "./node_modules/cleave.js/dist/cleave-esm.js"));
var BlazorCleave = /** @class */ (function () {
    function BlazorCleave() {
    }
    BlazorCleave.formatPhoneNumber = function (elem, countryCode) {
        var cleave = new cleave_js_1.default((elem), {
            phone: true,
    ...
    BlazorCleave.formatNumeral = function (elem, numeralType) {
        var cleave = new cleave_js_1.default((elem), {
            numeral: true,
...
/******/ })["default"];
//# sourceMappingURL=BlazorCleave.js.map